class Department < ActiveRecord::Base
  ...
  validates :start_year, numericality: {allow_nil: true, only_integer: true, greater_than_or_equal_to: 1000, less_than_or_equal_to: 9999}
  validates :end_year, numericality: {allow_nil: true, only_integer: true, greater_than_or_equal_to: 1000, less_than_or_equal_to: 9999}
