class GupAdminPerson
  ...
  def self.index_all opts = {}
    ...
    documents.each_with_index do |document, index|
      ...
      RestClient.put "#{APP_CONFIG['gup_admin_settings']['base_url']}/persons/?api_key=#{APP_CONFIG['gup_admin_settings']['api_key']}&initial_load=true", JSON.parse('{"data":' + document[1] + '}').to_json ,  content_type: :json
    end
  end
end
