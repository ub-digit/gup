...
export default Ember.Object.extend({
  ...
  endpoints: {
    ...
    endnote_file: {
      path: "endnote_files",
      singular: "endnote_file",
      plural: "endnote_files",
    },
    published_publication: {
      path: "published_publications",
      singular: "publication",
      plural: "publications",
    },
    review_publication: {
    ...
    biblreview_publication: {
      path: "biblreview_publications",
      singular: "publication",
      plural: "publications",
    },
    public_publication_list: {
      path: "public_publication_lists",
      singular: "publication",
      plural: "publications",
    },
  ...
  extractErrors: function (reason_or_data) {
    ...
    } else if (reason_or_data.statusText) {
      //TODO: Verify that removing (invalid?) reason_or_data.error case is ok/safe
      return {
  ...
  saveUpdate: function (name, id, data) {
    ...
    return this.send(this.urlOne(name, id), "put", dataObject).then(function (
      data
    ) {
      return that.extractOne(name, data);
    },
