export default {
  components: {
    ...
    fieldComponent: {
      ...
      artisticCheckbox: 'Ange om publikationen är konstnärligt arbete',
  ...
  login: {
    ...
    loginErrorUnknown: "Ett okänt fel har inträffat. Vänligen försök igen.",
  ...
  publications_list: {
    ...
    onlyArtisticLabel: 'Endast konstnärligt arbete',
